...
export function SidebarMenuFolder({ item }: SidebarMenuFolderType) {
  ...
  return (
    ...
    >
      <SidebarGroup
        className={cn("p-0", isOpen && "rounded-md bg-sidebar-accent")}
      >
        <SidebarGroupLabel
          asChild
          className={cn(
            "group/label h-9 text-base text-muted-foreground hover:bg-sidebar-accent hover:text-sidebar-accent-foreground",
