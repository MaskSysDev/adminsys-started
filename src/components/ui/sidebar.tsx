...
function SidebarProvider({
  ...
  const setOpen = useCallback(
    ...
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      // biome-ignore lint/suspicious/noDocumentCookie: Direct assigning to document.cookie is not recommended.
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: This hook specifies more dependencies than necessary: setOpenMobile
