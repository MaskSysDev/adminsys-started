...
export const metadata: Metadata = {
  ...
  description:
    ...
    "React App with Next.js, Typescript, TailwindCSS, Shadcn, ESLint, Prettier, Husky, Commitlint and more.",
  ...
  manifest: siteConfig.manifest || "/site.webmanifest", // Caminho do manifesto PWA
  ...
  openGraph: {
    ...
    description:
      siteConfig.description ||
      "React App with Next.js, Typescript, TailwindCSS, Shadcn, ESLint, Prettier, Husky, Commitlint and more.", // Descrição para compartilhamento
  ...
  twitter: {
    ...
    description:
      siteConfig.description ||
      "React App with Next.js, Typescript, TailwindCSS, Shadcn, ESLint, Prettier, Husky, Commitlint and more.", // Descrição para Twitter
    images: [
